...
function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10">
        ...
        <div className="w-full md:w-[500px]">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button
              ...
              className="bg-red-600 text-white px-8 py-4 rounded-2xl font-bold hover:bg-red-700 transition"
            >
              🚪 Logout
            </button>
          </div>
      ...
      <div className="mt-14">
        <h1 className="text-4xl font-bold text-gray-800">Uploaded Notes 📘</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-8">
          {notes.length > 0 ? (
            ...
            <div className="bg-white p-10 rounded-3xl shadow-lg">
              <h2 className="text-2xl text-gray-600">No Notes Uploaded Yet</h2>
            </div>
          )}
        </div>
      </div>
